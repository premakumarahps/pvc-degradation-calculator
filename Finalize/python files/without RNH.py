...
rate_constants = [1e-6, 0.4, 0.5, 0.1]
[k6, k7, k8, k9] = rate_constants
print("k6=",k6)
print("k7=",k7)
print("k8=",k8)
print("k9=",k9)
...
# Initial parameters
initial_PVC = 1.0
expected_lifetime = 1  # in hours

# Convert lifetime to seconds
time_seconds = expected_lifetime * 3600

# Initial concentrations
y0 = [initial_PVC, 1e-2, 1e-2, 1e-2]
[PVC, Cl_rad, R_rad, R_OO_rad]=y0
print("PVC=",PVC)
print("Cl_rad=",Cl_rad)
print("R_rad=",R_rad)
print("R_OO_rad=",R_OO_rad)

# Time span for the simulation
t_span = (0, time_seconds)

# Evaluation intervals
evaluation_intervals = np.linspace(0, time_seconds, 3600)
